...
class GBElevation:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GBElevation', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/GBElevation/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Calculate Elevations'),
            callback=self.run,
